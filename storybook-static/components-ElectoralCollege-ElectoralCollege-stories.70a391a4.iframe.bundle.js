    ...
    './src/components/ElectoralCollege/ElectoralCollege.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ElectoralCollegeTest: () => ElectoralCollegeTest,
          __namedExportsOrder: () => __namedExportsOrder,
          default: () => ElectoralCollege_stories,
        });
      var assets_namespaceObject = {};
      __webpack_require__.r(assets_namespaceObject),
        __webpack_require__.d(assets_namespaceObject, {
          bidenImg: () => biden_namespaceObject,
          kennedyImg: () => kennedyjr_namespaceObject,
          oliverImg: () => oliver_namespaceObject,
          steinImg: () => stein_namespaceObject,
          trumpImg: () => trump_namespaceObject,
        });
      ...
      const biden_namespaceObject =
          __webpack_require__.p + 'static/media/biden.fa4a8378.jpeg',
        stein_namespaceObject =
          __webpack_require__.p + 'static/media/stein.4f444866.jpg',
        kennedyjr_namespaceObject =
          __webpack_require__.p + 'static/media/kennedyjr.01a0a6c4.png',
        oliver_namespaceObject =
          __webpack_require__.p + 'static/media/oliver.322882a0.jpeg',
        trump_namespaceObject =
          __webpack_require__.p + 'static/media/trump.9e2f3149.jpeg',
        Candidate = (candidate) => {
          const { name, party, popularVoteTotals, winnerTakeAllTotal } =
              candidate,
            src = assets_namespaceObject[`${name.toLowerCase()}Img`];
          return React.createElement(
            'div',
            { className: 'candidate', id: name },
            React.createElement('h2', null, candidate.name),
            React.createElement('img', { src, alt: name }),
            React.createElement(components_ElectoralVotes, {
              party,
              popularVoteTotals,
              winnerTakeAllTotal,
            })
      ...
      const Candidates = (candidates) => {
          const { candidatesData, popularVoteTotals, winnerTakeAllTotals } =
              candidates,
            candidatesMap = candidatesData.map((candidate, i) =>
              React.createElement(components_Candidate, {
                name: candidate.name,
                key: `candidate-${i}`,
      ...
      const CandidatesWrapper = (candidatesWrapper) => {
          ...
          return React.createElement(
            'div',
            null,
            React.createElement('h1', null, 'Electoral College 2024'),
            React.createElement(
              'div',
              ...
              React.createElement(
                'h3',
                null,
                'Winner-Take-All Electoral Votes Counter'
              ),
              React.createElement(
                'h3',
                {
              ...
              React.createElement(
                'div',
                null,
                React.createElement('div', { className: 'votes-winner-line' }),
                React.createElement(
                  'div',
            ...
            React.createElement(
              ...
              React.createElement(
                'h3',
                null,
                'Proportional Electoral Votes Counter'
              ),
              React.createElement(
                'h3',
                {
            ...
            React.createElement(components_Candidates, {
          ...
          return React.createElement(
            ...
            React.createElement(
              'button',
              {
                ...
                onClick: () => {
                  const states =
                      document.getElementsByClassName('stateWrapper'),
      ...
      const Map = (mapData) => {
          ...
          return React.createElement(
            ...
            React.createElement(
              'div',
              { id: 'info-box', className: currentInfo ? 'show' : '' },
              ((info) => {
                const stateName = info.split('--')[0],
                  stateEvs = info.split('--')[1],
                  stateWinner = info.split('--')[2] || '';
                return React.createElement(
                  'div',
                  null,
                  React.createElement(
      ...
      const PopularVoteInput = (popularVoteInput) => {
          const {
            ...
            initialInputValue = percent || '',
            [evsAwarded, setEvsAwarded] = (0, react.useState)(0),
            [inputValue, setInputValue] = (0, react.useState)(
              initialInputValue
            ),
            [savedValue, setSavedValue] = (0, react.useState)(''),
            inputId = `${party}PopVoteInput`,
            inputPlaceholder = `${party.toUpperCase()} %`,
            calculateProportionalVotes = (event, savedValue) => {
      ...
      const CANDIDATES_DATA = [
        ...
        PopularVotes = (popularVotes) => {
          ...
          return React.createElement(
            ...
            popVotesDataValues.map((value, i) =>
              React.createElement(components_PopularVoteInput, {
                currentPVTotals,
                evs,
                handlePropVotes,
      ...
      const State = (stateInfo) => {
          ...
          return React.createElement(
            'div',
            { className: 'stateWrapper', id: name },
            React.createElement(
              'div',
              {
              ...
              React.createElement('span', { className: 'evs' }, evs)
            ),
            React.createElement('p', { className: 'stateName' }, name)
          );
        },
      ...
      const utilities_getStateWinnerNames = (data) => {
        ...
        States = (states) => {
          ...
          return React.createElement(
            ...
            React.createElement(components_Map, {
              ...
              statesData.map((state, i) =>
                -1 === state.name.indexOf('-CD')
                  ? React.createElement(
                      'div',
                      { key: `state-${i}` },
                      React.createElement(components_State, {
                        evs: state.evs,
                        isFromStorage,
                        name: state.name,
                        stateClickedFromMap:
                      ...
                      React.createElement(components_PopularVotes, {
                        currentPVTotals,
                        evs: state.evs,
                        handlePropVotes,
                        name: state.name,
      ...
      const calculatePercentage = (total) => (total / 538) * 100,
        ElectoralCollege = () => {
          ...
          (0, react.useEffect)(() => {
            ...
            (0, react.useEffect)(() => {
              isFromStorage || alert('no saved data so loading blank');
            }, [isFromStorage]);
          return React.createElement(
            'div',
            { className: 'App' },
            React.createElement(components_CandidatesWrapper, {
            ...
            React.createElement(components_States, {
            ...
            React.createElement(
              'div',
              { id: 'buttons' },
              React.createElement(components_SaveButton, {
                currentEVTotals: winnerTakeAllTotals,
                currentPVTotals: popularVoteTotals,
              }),
              React.createElement(components_ClearButton, null)
            )
          );
        },
      ...
      const ElectoralCollege_stories = {
          title: 'ReactComponent/ElectoralCollege',
          component: ElectoralCollege_ElectoralCollege,
        },
        ElectoralCollegeTest = (() =>
          React.createElement(ElectoralCollege_ElectoralCollege, null)).bind(
          {}
        ),
        __namedExportsOrder = ['ElectoralCollegeTest'];
      ElectoralCollegeTest.parameters = {
        ...ElectoralCollegeTest.parameters,
        docs: {
          ...ElectoralCollegeTest.parameters?.docs,
          source: {
            originalSource: '() => <ElectoralCollege />',
            ...ElectoralCollegeTest.parameters?.docs?.source,
          },
        },
      };
    },
