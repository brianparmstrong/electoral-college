    ...
    './src/components/ElectoralCollege/ElectoralCollege.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          default: () => ElectoralCollege_stories,
        });
      var jsx_runtime = __webpack_require__(
          './node_modules/react/jsx-runtime.js'
        ),
        react = __webpack_require__('./node_modules/react/index.js');
      const utilities_checkForWinner = (array) =>
          array.findIndex((votePercent) => votePercent > 50),
        utilities_getWinnerName = (winningParty = '') => {
          let stateWinner = '';
          switch (winningParty) {
            case '1':
        ...
        utilities_getWinnerClassName = (winner = '') => {
          let winnerClass = '';
          switch (winner) {
            case '1':
              winnerClass = 'gop';
          ...
          (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime.jsx)('span', {
                ...
                id: `${electoralVotes.party}-wta`,
                children: electoralVotes.winnerTakeAllTotal,
              }),
              (0, jsx_runtime.jsx)('p', {
                className: 'electoralVotesLabel',
              ...
              (0, jsx_runtime.jsx)('span', {
                className: 'electoralVotes',
                id: `${electoralVotes.party}-prop`,
                children: electoralVotes.popularVoteTotals,
              }),
            ],
          }),
        components_ElectoralVotes = ElectoralVotes;
      ElectoralVotes.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'ElectoralVotes',
      };
      const Candidate = (candidate) => {
          ...
          return (0, jsx_runtime.jsxs)('div', {
            className: `candidate candidate-${party}`,
            children: [
              (0, jsx_runtime.jsx)('h2', { children: candidate.name }),
              imageSrc &&
                (0, jsx_runtime.jsx)('img', { src: imageSrc, alt: name }),
              (0, jsx_runtime.jsx)(components_ElectoralVotes, {
                party,
                popularVoteTotals,
                winnerTakeAllTotal,
              }),
        ...
        components_Candidate = Candidate;
      ...
      const Candidates = (candidates) => {
          const {
            ...
            candidatesMap = candidatesData.map((candidate, i) =>
              (0, jsx_runtime.jsx)(
                components_Candidate,
                {
                  imageSrc: candidateImageSources?.[candidate.party],
                  name: candidate.name,
          ...
          return (0, jsx_runtime.jsx)('div', {
            ...
            children: candidatesMap,
          });
        },
        components_Candidates = Candidates;
      Candidates.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'Candidates',
      };
      const CandidatesWrapper = (candidatesWrapper) => {
          const {
              candidateImageSources,
              candidates,
              evPct,
            ...
            [wtaWinnerIndex, setWtaWinnerIndex] = (0, react.useState)(
              utilities_checkForWinner(winnerTakeAllTotals)
            ),
            [propWinnerIndex, setPropWinnerIndex] = (0, react.useState)(
              utilities_checkForWinner(popVoteTotals)
            ),
            [wtaWinnerName, setWtaWinnerName] = (0, react.useState)(
              utilities_getWinnerName(String(wtaWinnerIndex + 1))
            ),
            [propWinnerName, setPropWinnerName] = (0, react.useState)(
              utilities_getWinnerName(String(propWinnerIndex + 1))
            ),
            [wtaWinnerClassName, setWtaWinnerClassName] = (0, react.useState)(
              utilities_getWinnerClassName(String(wtaWinnerIndex + 1))
            ),
            [propWinnerClassName, setPropWinnerClassName] = (0, react.useState)(
              utilities_getWinnerClassName(String(propWinnerIndex + 1))
            );
          (0, react.useEffect)(() => {
            setPropWinnerIndex(utilities_checkForWinner(pvPct));
          }, [pvPct]),
            (0, react.useEffect)(() => {
              setWtaWinnerIndex(utilities_checkForWinner(evPct));
            }, [evPct]),
            (0, react.useEffect)(() => {
              const index = String(propWinnerIndex + 1),
                name = utilities_getWinnerName(index);
              setPropWinnerName(name),
                setPropWinnerClassName(utilities_getWinnerClassName(index));
            }, [propWinnerIndex]),
            (0, react.useEffect)(() => {
              const index = String(wtaWinnerIndex + 1),
                name = utilities_getWinnerName(index);
              setWtaWinnerName(name),
                setWtaWinnerClassName(utilities_getWinnerClassName(index));
            }, [wtaWinnerIndex]);
          const calculateUnawardedEvsPct = (percentages) =>
            100 - percentages.reduce((a, b) => a + b, 0);
          return (0, jsx_runtime.jsxs)('div', {
            children: [
              (0, jsx_runtime.jsx)('h1', {
                children: 'Electoral College 2024',
              }),
              (0, jsx_runtime.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, jsx_runtime.jsx)('h3', {
                    className: `wta-winner ${wtaWinnerClassName} ${wtaWinnerIndex > -1 ? 'show' : 'hide'}`,
                    children: `Winner: ${wtaWinnerName}`,
                  }),
                  (0, jsx_runtime.jsxs)('div', {
                    children: [
                      (0, jsx_runtime.jsx)('div', {
                        className: 'votes-winner-line',
                      }),
                      (0, jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, jsx_runtime.jsx)('span', {
                            ...
                            style: {
                              width: calculateUnawardedEvsPct(evPct) + '%',
                            },
                          }),
                          (0, jsx_runtime.jsx)('span', {
                            className: 'grn-votes',
              ...
              (0, jsx_runtime.jsxs)('div', {
                className: 'votes-counter',
                id: 'pop-votes-counter',
                children: [
                  (0, jsx_runtime.jsx)('h3', {
                    children: 'Proportional Electoral Votes Counter',
                  }),
                  (0, jsx_runtime.jsx)('h3', {
                    className: `prop-winner ${propWinnerClassName} ${propWinnerIndex > -1 ? 'show' : 'hide'}`,
                    children: `Winner: ${propWinnerName}`,
                  }),
                  (0, jsx_runtime.jsxs)('div', {
                    children: [
                      (0, jsx_runtime.jsx)('div', {
                      ...
                      (0, jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, jsx_runtime.jsx)('span', {
                            className: 'unawarded-votes',
                            style: {
                              width: calculateUnawardedEvsPct(pvPct) + '%',
                            },
                          }),
                          (0, jsx_runtime.jsx)('span', {
                            className: 'grn-votes',
              ...
              (0, jsx_runtime.jsx)(components_Candidates, {
                candidateImageSources,
        ...
        components_CandidatesWrapper = CandidatesWrapper;
      CandidatesWrapper.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'CandidatesWrapper',
      };
      const ClearButton = (clearButtonProps) => {
        ...
        components_ClearButton = ClearButton;
      ClearButton.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'ClearButton',
      };
      const SaveButton = (saveButtonProps) => {
          const { currentEVTotals, currentPVTotals, handleSave } =
            saveButtonProps;
          return (0, jsx_runtime.jsx)('div', {
            className: 'buttonWrapper',
            children: (0, jsx_runtime.jsx)('button', {
              ...
              onClick: () => {
                ...
                const dynamicSort = (property) => (a, b) =>
                  ...
                  setPopVoteStatus = (pvData) => {
                    const inputValues = [],
                      popVoteData = { name: '', values: inputValues },
                      inputElems = pvData?.elem?.querySelectorAll('.pvInput');
                    if (inputElems)
                ...
                for (let state = 0; state < statesLength; state++) {
                  const stateNode = states[state].childNodes[0];
                  (stateData = {
        ...
        components_SaveButton = SaveButton;
      ...
      const Map = (mapData) => {
          const {
            ...
            [buttonText, setButtonText] = (0, react.useState)('Hide Map'),
            [showMap, setShowMap] = (0, react.useState)(!0),
            [currentHoveredStateId, setCurrentHoveredStateId] = (0,
            react.useState)(''),
            [currentInfo, setCurrentInfo] = (0, react.useState)(''),
            [infoBoxWinnerNames, setInfoBoxWinnerNames] = (0, react.useState)(
              stateWinnerNames
            ),
            [updatedStateClassNames, setUpdatedStateClassNames] = (0,
            react.useState)({}),
            svgShowHideMapClass = showMap ? '' : 'hide';
          (0, react.useEffect)(() => {
            hasClearedSavedData && setUpdatedStateClassNames({});
          }, [hasClearedSavedData]),
            (0, react.useEffect)(() => {
              const stateId = newStateData?.stateId,
                newWinningPartyClass = utilities_getWinnerClassName(
                  newStateData?.newWinningParty
                );
              if (stateId) {
                const updateObj = { [stateId]: newWinningPartyClass };
                ...
                setCurrentInfo((currentInfo) => {
                  ...
                  return (
                    currentInfo &&
                      ...
                      (currentInfoSplit[2] =
                        winnerNames?.[currentHoveredStateId] ?? '')),
                    currentInfoSplit.join('--')
                  );
                });
          ...
          const handleClick = (event) => {
            ...
            getStateClassName = (stateId) => {
              const stateToCheck = statesData.find(
                (state) => state.stateCode === stateId
              );
              return (
                (-1 === Object.keys(updatedStateClassNames).indexOf(stateId) &&
                  utilities_getWinnerClassName(stateToCheck?.winner)) ||
                ''
              );
            };
          return (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime.jsx)('button', {
                type: 'button',
                onClick: () => {
                  let newButtonText = 'Hide Map';
                  showMap && (newButtonText = 'Show Map'),
              ...
              (0, jsx_runtime.jsx)('div', {
                ...
                className: currentInfo
                  ? `show ${((info) => {
                      ...
                      return utilities_getWinnerClassName(winner);
                    })(currentInfo)}`
                  : '',
                children: ((info) => {
                  const splitInfo = info.split('--'),
                    stateName = splitInfo[0],
                    stateEvs = splitInfo[1],
                    stateWinner = splitInfo[2] || '';
                  return (0, jsx_runtime.jsxs)('div', {
                    children: [
                      (0, jsx_runtime.jsx)('p', {
                      ...
                      (0, jsx_runtime.jsx)('p', {
                        className: 'map-info-stateevs',
                        children: stateEvs,
                      }),
                      (0, jsx_runtime.jsx)('p', {
                        className: 'map-infor-statewinner',
                        children: `Winner: ${stateWinner}`,
                      }),
                    ],
                  });
                })(currentInfo),
                  ...
                  (0, jsx_runtime.jsxs)('g', {
                    ...
                    children: [
                      (0, jsx_runtime.jsx)('path', {
                        id: 'HI',
                        className: updatedStateClassNames.HI
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'AK',
                        className: updatedStateClassNames.AK
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'FL',
                        className: updatedStateClassNames.FL
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'SC',
                        className: updatedStateClassNames.SC
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'GA',
                        className: updatedStateClassNames.GA
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'AL',
                        className: updatedStateClassNames.AL
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'NC',
                        className: updatedStateClassNames.NC
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'TN',
                        className: updatedStateClassNames.TN
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'RI',
                        className: updatedStateClassNames.RI
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'CT',
                        className: updatedStateClassNames.CT
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'MA',
                        className: updatedStateClassNames.MA
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'ME',
                        className: updatedStateClassNames.ME
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'NH',
                        className: updatedStateClassNames.NH
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'VT',
                        className: updatedStateClassNames.VT
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'NY',
                        className: updatedStateClassNames.NY
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'NJ',
                        className: updatedStateClassNames.NJ
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'PA',
                        className: updatedStateClassNames.PA
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'DE',
                        className: updatedStateClassNames.DE
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'MD',
                        className: updatedStateClassNames.MD
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'WV',
                        className: updatedStateClassNames.WV
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'KY',
                        className: updatedStateClassNames.KY
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'OH',
                        className: updatedStateClassNames.OH
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'MI',
                        className: updatedStateClassNames.MI
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'WY',
                        className: updatedStateClassNames.WY
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'MT',
                        className: updatedStateClassNames.MT
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'ID',
                        className: updatedStateClassNames.ID
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'WA',
                        className: updatedStateClassNames.WA
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'TX',
                        className: updatedStateClassNames.TX
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'CA',
                        className: updatedStateClassNames.CA
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'AZ',
                        className: updatedStateClassNames.AZ
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'NV',
                        className: updatedStateClassNames.NV
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'UT',
                        className: updatedStateClassNames.UT
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'CO',
                        className: updatedStateClassNames.CO
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'NM',
                        className: updatedStateClassNames.NM
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'OR',
                        className: updatedStateClassNames.OR
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'ND',
                        className: updatedStateClassNames.ND
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'SD',
                        className: updatedStateClassNames.SD
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'NE',
                        className: updatedStateClassNames.NE
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'IA',
                        className: updatedStateClassNames.IA
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'MS',
                        className: updatedStateClassNames.MS
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'IN',
                        className: updatedStateClassNames.IN
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'IL',
                        className: updatedStateClassNames.IL
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'MN',
                        className: updatedStateClassNames.MN
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'WI',
                        className: updatedStateClassNames.WI
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'MO',
                        className: updatedStateClassNames.MO
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'AR',
                        className: updatedStateClassNames.AR
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'OK',
                        className: updatedStateClassNames.OK
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'KS',
                        className: updatedStateClassNames.KS
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'LA',
                        className: updatedStateClassNames.LA
                      ...
                      (0, jsx_runtime.jsx)('path', {
                        id: 'VA',
                        className: updatedStateClassNames.VA
                      ...
                      (0, jsx_runtime.jsxs)('g', {
                        ...
                        children: [
                          ...
                          (0, jsx_runtime.jsx)('circle', {
                            id: 'DC',
                            className: updatedStateClassNames.DC
                              ? updatedStateClassNames.DC
                              : getStateClassName('DC'),
                            onClick: (event) => {
                              const { id } = event.target;
                              handleMapStateClick(
                                `${id}-${event.currentTarget.classList}`
                              );
                            },
                            onMouseEnter: (event) => {
                              const { id } = event.target;
                              setCurrentHoveredStateId(id),
                                setCurrentInfo(
                                  event.currentTarget.dataset.info
                                );
                            },
                            onMouseLeave: handleMouseLeave,
        ...
        components_Map = Map;
      Map.__docgenInfo = { description: '', methods: [], displayName: 'Map' };
      const PopularVoteInput = (popularVoteInput) => {
          const {
            currentPVTotals,
            evs,
            handlePropVotes,
          ...
          'California' === name &&
            ...
            console.log('hasClearedSavedData :::: ', hasClearedSavedData));
          const initialInputValue = Number(percent) > 0 ? percent : '';
          'California' === name &&
            console.log('initialInputValue :::: ', initialInputValue);
          const [evsAwarded, setEvsAwarded] = (0, react.useState)(0),
            [inputValue, setInputValue] = (0, react.useState)(
              initialInputValue
            );
          'California' === name && console.log('inputValue :::: ', inputValue);
          const [savedValue, setSavedValue] = (0, react.useState)(''),
            inputId = `${party}PopVoteInput`,
            inputPlaceholder = `${party.toUpperCase()} %`;
          (0, react.useEffect)(() => {
            hasClearedSavedData && setInputValue('');
          }, [hasClearedSavedData]);
          const calculateProportionalVotes = (event, savedValue) => {
            const eventTarget = event?.target,
              value = eventTarget?.value,
              newInputValue = savedValue
                ? Number(savedValue)
                : eventTarget
                  ? Number(value)
                  : 0;
            ...
            'Maine' === name
              ? (totalEvs = '4')
              : 'Nebraska' === name && (totalEvs = '5');
            const popVotePercent =
                Boolean(newInputValue) || percent ? newInputValue / 100 : 0,
              evsWon = Math.round(Number(totalEvs) * popVotePercent),
              polParty =
                savedValue || !1 === Boolean(event)
                  ? null
                  : event?.target.dataset.party;
            let newGopPropTotal = currentPVTotals[0],
              newDemPropTotal = currentPVTotals[1],
              newLibPropTotal = currentPVTotals[2],
              newGrnPropTotal = currentPVTotals[3],
              newIndPropTotal = currentPVTotals[4];
          ...
          return (0, jsx_runtime.jsx)('div', {
            ...
            children: (0, jsx_runtime.jsx)('input', {
              className: 'pvInput',
              'data-evsawarded': String(
                calculateProportionalVotes(null, inputValue)
              ),
              'data-party': party,
              'data-statename': name,
              ...
              id: inputId,
              onBlur: (event) => {
                'Calfornia' === name && console.log('blur'), event.persist();
              ...
              onFocus: (event) => {
                const evsAwardedData = Number(
                    event.currentTarget.dataset.evsawarded
                  ),
                  newEvsAwarded = isNaN(evsAwardedData)
                    ? evsAwarded
                    : evsAwardedData;
                event.persist(),
        ...
        components_PopularVoteInput = PopularVoteInput;
      PopularVoteInput.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'PopularVoteInput',
      };
      const PARTY_MAP = ['gop', 'dem', 'lib', 'grn', 'ind'],
        STATES_DATA = [
        ...
        PopularVotes = (popularVotes) => {
          const {
            ...
            popVotesDataValues = popVotesData
              ? popVotesData.values
              : ['0', '0', '0', '0', '0'],
            wrapperClass = showPopVotes ? '' : 'hide',
            [clearInputs, setClearInputs] = (0, react.useState)(
              hasClearedSavedData
            );
          (0, react.useEffect)(() => {
          ...
          return (0, jsx_runtime.jsx)('div', {
            className: `popVotesWrapper ${wrapperClass}`,
            children: popVotesDataValues.map((value, i) =>
              (0, jsx_runtime.jsx)(
                components_PopularVoteInput,
                {
                  currentPVTotals,
                  evs,
                  handlePropVotes,
                  ...
                  name,
                  party: PARTY_MAP[i],
                  percent: 'true' === clearInputs ? '0' : popVotesData && value,
                  stateEvs,
                },
                `${name}-${PARTY_MAP[i]}`
              )
        ...
        components_PopularVotes = PopularVotes;
      PopularVotes.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'PopularVotes',
      };
      const State = (stateInfo) => {
          const {
            ...
            stateNode = (0, react.useRef)(null),
            [winningParty, setWinningParty] = (0, react.useState)(
              isFromStorage ? Number(winner) : 0
            ),
            [winningPartyClass, setWinningPartyClass] = (0, react.useState)(
              utilities_getWinnerClassName(winner)
            );
          (0, react.useEffect)(() => {
            'false' !== stateClickedFromMap && stateNode?.current?.click();
          }, [stateClickedFromMap]);
          return (
            (0, react.useEffect)(() => {
              '0' === winner && (setWinningParty(0), setWinningPartyClass(''));
            }, [winner]),
            (0, jsx_runtime.jsxs)('div', {
              ...
              children: [
                (0, jsx_runtime.jsx)('div', {
                  ...
                  onClick: (event) => {
                    const newWinningParty =
                      5 === winningParty ? 0 : winningParty + 1;
      ...
      const utilities_getStateWinnerNames = (data) => {
          const stateWinnerNames = {};
          return (
            data.map(
              (state) => (
                -1 === state.name.indexOf('-CD') &&
                  (stateWinnerNames[state.stateCode] = utilities_getWinnerName(
                    state.winner
                  )),
                stateWinnerNames
              )
        ...
        States = (states) => {
          const {
            ...
            [buttonText, setButtonText] = (0, react.useState)(
              'Hide Popular Votes'
            ),
            [showPopVotes, setShowPopVotes] = (0, react.useState)(!0),
            [statesDataToUse, setStatesDataToUse] = (0, react.useState)(
              statesData
            ),
            [newStateData, setNewStateData] = (0, react.useState)(null),
            [stateWinnerNames, setStateWinnerNames] = (0, react.useState)(
              utilities_getStateWinnerNames(statesData)
            ),
            [stateClickedFromMap, setStateClickedFromMap] = (0, react.useState)(
              ''
            ),
            [clearMapWinners, setClearMapWinners] = (0, react.useState)(
              hasClearedSavedData
            ),
            [clearPopularVotes, setClearPopularVotes] = (0, react.useState)(
              hasClearedSavedData
            );
          (0, react.useEffect)(() => {
            setStatesDataToUse(statesData),
              setStateWinnerNames(utilities_getStateWinnerNames(statesData));
          }, [
            utilities_getStateWinnerNames,
            setStateWinnerNames,
            setStatesDataToUse,
            statesData,
          ]),
          ...
          const toggleWinner = (data) => {
            let newGopTotal = currentEVTotals[0],
              newDemTotal = currentEVTotals[1],
              newLibTotal = currentEVTotals[2],
              newGrnTotal = currentEVTotals[3],
              newIndTotal = currentEVTotals[4],
              newEVTotals = [];
            switch (data.newWinningParty) {
              case '1':
                ...
                break;
              case '2':
                (newDemTotal += data.evs), (newGopTotal -= data.evs);
                break;
              case '3':
                (newLibTotal += data.evs), (newDemTotal -= data.evs);
                break;
              case '4':
                (newGrnTotal += data.evs), (newLibTotal -= data.evs);
                break;
              case '5':
                (newIndTotal += data.evs), (newGrnTotal -= data.evs);
                break;
              default:
            ...
            const updateObj = {
              [data.stateId]: utilities_getWinnerName(data.newWinningParty),
            };
            setNewStateData({
          ...
          return (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime.jsx)(components_Map, {
              ...
              (0, jsx_runtime.jsxs)('div', {
                ...
                children: [
                  (0, jsx_runtime.jsx)('button', {
                    type: 'button',
                    onClick: () => {
                      let newButtonText = 'Hide Popular Votes';
                      showPopVotes && (newButtonText = 'Show Popular Votes'),
                        setButtonText(newButtonText),
                        setShowPopVotes(!showPopVotes);
                    },
                    children: buttonText,
                  }),
                  ((stateClicked = stateClickedFromMap),
                  statesDataToUse.map((state, i) =>
                    -1 === state.name.indexOf('-CD')
                      ? (0, jsx_runtime.jsxs)(
                          'div',
                          {
                            ...
                            children: [
                              (0, jsx_runtime.jsx)(components_State, {
                                evs: state.evs,
                                isFromStorage,
                                name: state.name,
                                stateClickedFromMap:
                                  stateClicked?.split('-')[0] ===
                                  state.stateCode
                                    ? stateClicked
                                    : 'false',
                              ...
                              (0, jsx_runtime.jsx)(components_PopularVotes, {
                                currentPVTotals,
                                evs: state.evs,
                                handlePropVotes,
                      ...
                      : (0, jsx_runtime.jsx)(
                          ...
                          {
                            className: `state-control ${stateControlSize}`,
                            children: (0, jsx_runtime.jsx)(components_State, {
                              evs: state.evs,
                              isFromStorage,
                              name: state.name,
        ...
        components_States = States;
      States.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'States',
      };
      const calculatePercentage = (total) => (total / 538) * 100;
      var injectStylesIntoStyleTag = __webpack_require__(
        ...
        style = __webpack_require__(
          './node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[2]!./src/style.scss'
        ),
        options = {};
      ...
      const ElectoralCollege = (props) => {
          const {
              candidateImageSources,
              candidatesData,
              enableStickyEVCounter = !0,
              mapSize = 'large',
              stateControlSize = 'large',
            } = props,
            [isFromStorage, setIsFromStorage] = (0, react.useState)(
              Boolean(localStorage?.getItem('ElectoralCollegeStatus'))
            ),
            startingEVTotals = isFromStorage
              ? JSON.parse(localStorage?.getItem('WinnerTakeAllTotals'))
              : [0, 0, 0, 0, 0],
            [popularVoteTotals, setPopularVoteTotals] = (0, react.useState)(
              isFromStorage
                ? JSON.parse(localStorage?.getItem('PopularVoteTotals'))
                : [0, 0, 0, 0, 0]
            ),
            [gopTotal, setGopTotal] = (0, react.useState)(startingEVTotals[0]),
            [demTotal, setDemTotal] = (0, react.useState)(startingEVTotals[1]),
            [libTotal, setLibTotal] = (0, react.useState)(startingEVTotals[2]),
            [grnTotal, setGrnTotal] = (0, react.useState)(startingEVTotals[3]),
            [indTotal, setIndTotal] = (0, react.useState)(startingEVTotals[4]),
            [winnerTakeAllTotals, setWinnerTakeAllTotals] = (0, react.useState)(
              [gopTotal, demTotal, libTotal, grnTotal, indTotal]
            ),
            [evPct, setEvPct] = (0, react.useState)(
              winnerTakeAllTotals.map((total) => calculatePercentage(total))
            ),
            [pvPct, setPvPct] = (0, react.useState)(
              popularVoteTotals.map((total) => calculatePercentage(total))
            ),
            [showSavedMessage, setShowSavedMessage] = (0, react.useState)(!1),
            [showClearedMessage, setShowClearedMessage] = (0, react.useState)(
              !1
            ),
            [hasClearedSavedData, setHasClearedSavedData] = (0, react.useState)(
              'false'
            ),
            [statesData, setStatesData] = (0, react.useState)(
              isFromStorage
                ? JSON.parse(localStorage.getItem('ElectoralCollegeStatus'))
                : STATES_DATA
            ),
            [popVotesData, setPopVotesData] = (0, react.useState)(
              isFromStorage
                ? JSON.parse(localStorage.getItem('PopularVoteStatus'))
                : []
            );
          (0, react.useEffect)(() => {
            enableStickyEVCounter &&
              (window.onscroll = () =>
                (() => {
                  const candidatesEVCounter =
                    document.querySelector('.candidatesWrapper');
                  if (candidatesEVCounter instanceof HTMLElement) {
                    const candidatesEVCounterOffsetTop =
                      candidatesEVCounter.offsetTop;
                    window.pageYOffset > candidatesEVCounterOffsetTop
          ...
          const handlePropVotes = (newPVTotals) => {
              const gopPvPct = calculatePercentage(newPVTotals[0]),
                demPvPct = calculatePercentage(newPVTotals[1]),
                libPvPct = calculatePercentage(newPVTotals[2]),
                grnPvPct = calculatePercentage(newPVTotals[3]),
                indPvPct = calculatePercentage(newPVTotals[4]);
              setPopularVoteTotals(newPVTotals),
                setPvPct([gopPvPct, demPvPct, libPvPct, grnPvPct, indPvPct]);
            },
            handleStateWinner = (newEVTotals) => {
              const gopPct = calculatePercentage(newEVTotals[0]),
                demPct = calculatePercentage(newEVTotals[1]),
                libPct = calculatePercentage(newEVTotals[2]),
                grnPct = calculatePercentage(newEVTotals[3]),
                indPct = calculatePercentage(newEVTotals[4]);
          ...
          return (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime.jsx)(components_CandidatesWrapper, {
                candidateImageSources,
              ...
              (0, jsx_runtime.jsx)(components_States, {
              ...
              'undefined' != typeof Storage &&
                (0, jsx_runtime.jsxs)('div', {
                  id: 'buttons',
                  children: [
                    (0, jsx_runtime.jsx)(components_SaveButton, {
                      currentEVTotals: winnerTakeAllTotals,
                      currentPVTotals: popularVoteTotals,
                      handleSave: () => {
                        setStatesData(
                          ...
                          setIsFromStorage(!0),
                          setShowClearedMessage(!1),
                          setShowSavedMessage(!0),
                          setTimeout(() => setShowSavedMessage(!1), 3e3);
                      },
                    }),
                    isFromStorage &&
                      (0, jsx_runtime.jsx)(components_ClearButton, {
                        handleClear: () => {
                          localStorage.removeItem('ElectoralCollegeStatus'),
                            ...
                            setIsFromStorage(!1),
                            setShowSavedMessage(!1),
                            setShowClearedMessage(!0),
                            setTimeout(() => {
                              setShowClearedMessage(!1),
                    ...
                    (0, jsx_runtime.jsx)('p', {
                      className: '' + (showSavedMessage ? 'show' : 'hide'),
                      children: 'Saved!',
                    }),
                    (0, jsx_runtime.jsx)('p', {
                      className: '' + (showClearedMessage ? 'show' : 'hide'),
                      children: 'Cleared!',
                    }),
                  ],
                }),
        ...
        ElectoralCollege_ElectoralCollege = ElectoralCollege;
      ElectoralCollege.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'ElectoralCollege',
      };
      const ElectoralCollege_stories = {
          component: ElectoralCollege_ElectoralCollege,
        ...
        Example = {
          args: {
            ...
            candidatesData: [
              { name: 'Trump', party: 'gop' },
              { name: 'Harris', party: 'dem' },
              { name: 'Oliver', party: 'lib' },
              { name: 'Stein', party: 'grn' },
              { name: 'Kennedy', party: 'ind' },
            ],
            mapSize: 'medium',
            stateControlSize: 'small',
          },
        },
        __namedExportsOrder = ['Example'];
      Example.parameters = {
        ...Example.parameters,
        docs: {
    ...
    './node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[2]!./src/style.scss':
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          '.electoral-college-root{font-family:Helvetica}.candidatesWrapper{display:flex;justify-content:space-around;text-align:center}.candidatesWrapper.sticky{background-color:#fff;position:fixed;top:0;width:100%;z-index:100}.candidatesWrapper.sticky h2{font-size:1.35em;margin-block:.5em}.candidatesWrapper.sticky .candidate{height:100%;margin:0}.candidatesWrapper.sticky img{display:none}.candidatesWrapper.sticky .electoralVotes{font-size:25px;height:30px}.candidatesWrapper.sticky .electoralVotesLabel{margin-block:.5em}.candidate{margin:10px}.candidate img{height:100px}.candidate-gop,.gop-votes{background-color:rgba(255,0,0,.75)}.candidate-dem,.dem-votes{background-color:rgba(0,70,255,.75)}.candidate-lib,.lib-votes{background-color:rgba(255,215,0,.75)}.candidate-grn,.grn-votes{background-color:rgba(0,200,0,.75)}.candidate-ind,.ind-votes{background-color:#d3d3d3}.electoralVotesWrapper{font-size:35px;margin-top:5px}.electoralVotesLabel{font-size:16px}.electoralVotes{background-color:#fff;border:1px solid #000;display:flex;height:40px;justify-content:space-around}.electoralVotes#gop-wta,.electoralVotes#gop-prop{color:rgba(255,0,0,.75)}.electoralVotes#dem-wta,.electoralVotes#dem-prop{color:rgba(0,70,255,.75)}.electoralVotes#lib-wta,.electoralVotes#lib-prop{color:rgba(255,215,0,.75)}.electoralVotes#grn-wta,.electoralVotes#grn-prop{color:rgba(0,200,0,.75)}.electoralVotes#ind-wta,.electoralVotes#ind-prop{color:#d3d3d3}.votes-winner-line{border-top:15px solid #000;border-right:15px solid rgba(0,0,0,0);border-left:15px solid rgba(0,0,0,0);height:0px;width:0px;margin:0 auto 1px}.votes-parties{border:1px solid #777;height:20px}.votes-parties>span{display:inline-block;height:inherit}.statesWrapper{display:flex;flex-wrap:wrap;justify-content:space-around;margin-top:10px}.statesWrapper button{cursor:pointer}.state-control{flex:0;margin-top:10px}.state-control .state{background-color:rgba(0,0,0,0);border:1px solid #000;border-radius:3px;cursor:pointer;height:30px;margin:0 auto;width:100px}.state-control.small .state{width:70px}.state-control.small .evs{font-size:20px}.state-control.small .stateName{font-size:.75em;height:25px}.state-control.small .pvInput{width:85%}.state-control.medium .pvInput{width:90%}.stateWrapper{margin:5px;text-align:center}.wta-winner,.prop-winner{background-color:none;border:1px solid #000;border-radius:3px}.state.gop,.wta-winner.gop,.prop-winner.gop{background-color:rgba(255,0,0,.75);border:1px solid rgba(255,0,0,.75)}.state.dem,.wta-winner.dem,.prop-winner.dem{background-color:rgba(0,70,255,.75);border:1px solid rgba(0,70,255,.75)}.state.lib,.wta-winner.lib,.prop-winner.lib{background-color:rgba(255,215,0,.75);border:1px solid rgba(255,215,0,.75)}.state.grn,.wta-winner.grn,.wta-winner.grn{background-color:rgba(0,200,0,.75);border:1px solid rgba(0,200,0,.75)}.state.ind,.wta-winner.ind,.prop-winner.ind{background-color:#d3d3d3;border:1px solid #d3d3d3}.evs{font-size:22px;position:relative;top:10%}.pvInputWrapper{margin-bottom:3px}.pvInput{border-radius:3px;border:2px solid}.pvInput[data-party=gop]{border-color:rgba(255,0,0,.75)}.pvInput[data-party=dem]{border-color:rgba(0,70,255,.75)}.pvInput[data-party=lib]{border-color:rgba(255,215,0,.75)}.pvInput[data-party=grn]{border-color:rgba(0,200,0,.75)}.pvInput[data-party=ind]{border-color:#d3d3d3}.hide{display:none}.show{display:block}#buttons .show{display:inline-block}.buttonWrapper{display:inline-block;margin:10px 20px 0 0}.buttonWrapper button{border:0;cursor:pointer;display:block;font-family:Helvetica;font-size:30px}#saveButton{background-color:lime}#clearButton{background-color:red}#map-wrapper{position:relative}#map-wrapper button{margin:20px;padding:20px}#us-map{display:block}#us-map.hide{display:none}#us-map.small{height:50%;width:50%}#us-map.medium{height:75%;width:75%}#us-map.large{height:100%;width:100%}path:hover,circle:hover{stroke:#000 !important;stroke-width:2px;stroke-linejoin:round;fill:#fff;cursor:pointer}#path67{fill:none !important;stroke:#a9a9a9 !important;cursor:default}#info-box{background-color:#fff;border:5px solid rgba(0,0,0,.75);border-radius:5px;display:none;font-family:arial;padding:5px 20px;position:fixed;right:0;top:0;width:20%;z-index:1000}#info-box.show{display:block}#info-box.gop{border-color:rgba(255,0,0,.75)}#info-box.dem{border-color:rgba(0,70,255,.75)}#info-box.lib{border-color:rgba(255,215,0,.75)}#info-box.grn{border-color:rgba(0,200,0,.75)}#info-box.ind{border-color:#d3d3d3}svg path,circle,path:hover,circle:hover{fill:#fff}svg .gop,path.gop:hover,circle.gop:hover{fill:rgba(255,0,0,.75)}svg .dem,path.dem:hover,circle.dem:hover{fill:rgba(0,70,255,.75)}svg .lib,path.lib:hover,circle.lib:hover{fill:rgba(255,215,0,.75)}svg .grn,path.grn:hover,circle.grn:hover{fill:rgba(0,200,0,.75)}svg .ind,path.ind:hover,circle.ind:hover{fill:#d3d3d3}',
          '',
          {
            version: 3,
            ...
            names: [],
            mappings:
              'AAAA,wBACE,qBAAA,CAGF,mBACE,YAAA,CACA,4BAAA,CACA,iBAAA,CAEA,0BACE,qBAAA,CACA,cAAA,CACA,KAAA,CACA,UAAA,CACA,WAAA,CAEA,6BACE,gBAAA,CACA,iBAAA,CAGF,qCACE,WAAA,CACA,QAAA,CAGF,8BACE,YAAA,CAGF,0CACE,cAAA,CACA,WAAA,CAGF,+CACE,iBAAA,CAKN,WACE,WAAA,CAEA,eACE,YAAA,CAIJ,0BAEE,kCAAA,CAGF,0BAEE,mCAAA,CAGF,0BAEE,oCAAA,CAGF,0BAEE,kCAAA,CAGF,0BAEE,wBAAA,CAGF,uBACE,cAAA,CACA,cAAA,CAGF,qBACE,cAAA,CAGF,gBACE,qBAAA,CACA,qBAAA,CACA,YAAA,CACA,WAAA,CACA,4BAAA,CAGF,iDAEE,uBAAA,CAEF,iDAEE,wBAAA,CAEF,iDAEE,yBAAA,CAEF,iDAEE,uBAAA,CAEF,iDAEE,aAAA,CAGF,mBACE,0BAAA,CACA,qCAAA,CACA,oCAAA,CACA,UAAA,CACA,SAAA,CACA,iBAAA,CAGF,eACE,qBAAA,CACA,WAAA,CAGF,oBACE,oBAAA,CACA,cAAA,CAGF,eACE,YAAA,CACA,cAAA,CACA,4BAAA,CACA,eAAA,CAEA,sBACE,cAAA,CAIJ,eACE,MAAA,CACA,eAAA,CAEA,sBACE,8BAAA,CACA,qBAAA,CACA,iBAAA,CACA,cAAA,CACA,WAAA,CACA,aAAA,CACA,WAAA,CAIA,4BACE,UAAA,CAGF,0BACE,cAAA,CAGF,gCACE,eAAA,CACA,WAAA,CAGF,8BACE,SAAA,CAKF,+BACE,SAAA,CAKN,cACE,UAAA,CACA,iBAAA,CAGF,yBAEE,qBAAA,CACA,qBAAA,CACA,iBAAA,CAGF,4CAGE,kCAAA,CACA,kCAAA,CAEF,4CAGE,mCAAA,CACA,mCAAA,CAEF,4CAGE,oCAAA,CACA,oCAAA,CAEF,2CAGE,kCAAA,CACA,kCAAA,CAEF,4CAGE,wBAAA,CACA,wBAAA,CAGF,KACE,cAAA,CACA,iBAAA,CACA,OAAA,CAGF,gBACE,iBAAA,CAGF,SACE,iBAAA,CACA,gBAAA,CAEA,yBACE,8BAAA,CAGF,yBACE,+BAAA,CAGF,yBACE,gCAAA,CAGF,yBACE,8BAAA,CAGF,yBACE,oBAAA,CAIJ,MACE,YAAA,CAGF,MACE,aAAA,CAIA,eACE,oBAAA,CAIJ,eACE,oBAAA,CACA,oBAAA,CAEA,sBACE,QAAA,CACA,cAAA,CACA,aAAA,CACA,qBAAA,CACA,cAAA,CAIJ,YACE,qBAAA,CAGF,aACE,oBAAA,CAGF,aACE,iBAAA,CAEA,oBACE,WAAA,CACA,YAAA,CAIJ,QACE,aAAA,CAEA,aACE,YAAA,CAGF,cACE,UAAA,CACA,SAAA,CAGF,eACE,UAAA,CACA,SAAA,CAGF,cACE,WAAA,CACA,UAAA,CAIJ,wBAEE,sBAAA,CACA,gBAAA,CACA,qBAAA,CACA,SAAA,CACA,cAAA,CAEF,QACE,oBAAA,CACA,yBAAA,CACA,cAAA,CAEF,UACE,qBAAA,CACA,gCAAA,CACA,iBAAA,CACA,YAAA,CACA,iBAAA,CACA,gBAAA,CACA,cAAA,CACA,OAAA,CACA,KAAA,CACA,SAAA,CACA,YAAA,CAEA,eACE,aAAA,CAGF,cACE,8BAAA,CAGF,cACE,+BAAA,CAGF,cACE,gCAAA,CAGF,cACE,8BAAA,CAGF,cACE,oBAAA,CAGJ,wCAIE,SAAA,CAEF,yCAGE,sBAAA,CAEF,yCAGE,uBAAA,CAEF,yCAGE,wBAAA,CAEF,yCAGE,sBAAA,CAEF,yCAGE,YAAA',
            sourcesContent: [
