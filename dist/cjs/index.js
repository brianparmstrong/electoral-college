...
var s = t.exports,
  ...
  f = function (l) {
    ...
    return s.jsxs(
      'div',
      e(
        { className: 'candidate', id: t },
        {
          children: [
            s.jsx('h2', { children: l.name }),
            s.jsx('img', { src: a, alt: t }),
            s.jsx(p, { party: n, popularVoteTotals: o, winnerTakeAllTotal: r }),
          ],
        }
      )
    );
  ...
  m = function (a) {
    var t = a.candidateImageSources,
      ...
      y = g[0],
      M = g[1],
      b = l.useState(d(String(m + 1))),
      k = b[0],
      x = b[1],
      N = l.useState(d(String(y + 1))),
      C = N[0],
      E = N[1],
      j = l.useState(u(String(m + 1))),
      L = j[0],
      S = j[1],
      w = l.useState(u(String(y + 1))),
      V = w[0],
      T = w[1];
    l.useEffect(
      function () {
  ...
  y = function (a) {
    ...
    l.useEffect(
      function () {
        var l,
          a = null == n ? void 0 : n.stateId,
          t = u(null == n ? void 0 : n.newWinningParty);
        if (a) {
          var o = (((l = {})[a] = t), l);
          L(function (l) {
            return e(e({}, l), o);
          ...
          C(o),
            k(function (l) {
              ...
              return (
                l &&
                  ((t = l.split('--'))[2] =
                    null !== (e = null == a ? void 0 : a[g]) && void 0 !== e
                      ? e
                      : ''),
                t.join('--')
              );
    ...
    var w,
      ...
      O = function (l) {
        var e = l.target.id;
        y(e), k(l.currentTarget.dataset.info);
      },
      z = function () {
        k('');
      },
                  ...
                  children:
                    ...
                    s.jsxs('div', {
                      children: [
                        ...
                        s.jsx(
                          'p',
                          e({ className: 'map-info-stateevs' }, { children: T })
                        ),
                        s.jsx(
                          'p',
                          e(
                            { className: 'map-infor-statewinner' },
                            { children: 'Winner: '.concat(A) }
                          )
                        ),
                      ],
                    })),
                        ...
                        { id: 'g5' },
                        {
                          children: [
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Hawaii--4 EVs--'.concat(N.HI),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Alaska--3 EVs--'.concat(N.AK),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Florida--30 EVs--'.concat(N.FL),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Georgia--16 EVs--'.concat(N.GA),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Alabama--9 EVs--'.concat(N.AL),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Tennessee--11 EVs--'.concat(N.TN),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Rhode Island--4 EVs--'.concat(N.RI),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Connecticut--7 EVs--'.concat(N.CT),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Maine--4 Split EVs--'.concat(N.ME),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Vermont--3 EVs--'.concat(N.VT),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'New York--28 EVs--'.concat(N.NY),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'New Jersey--14 EVs--'.concat(N.NJ),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Delaware--3 EVs--'.concat(N.DE),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Maryland--10 EVs--'.concat(N.MD),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Kentucky--8 EVs--'.concat(N.KY),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Ohio--17 EVs--'.concat(N.OH),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Michigan--15 EVs--'.concat(N.MI),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Wyoming--3 EVs--'.concat(N.WY),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Montana--3 EVs--'.concat(N.MT),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Idaho--4 EVs--'.concat(N.ID),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Washington--12 EVs--'.concat(N.WA),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Texas--40 EVs--'.concat(N.TX),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'California--54 EVs--'.concat(N.CA),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Arizona--11 EVs--'.concat(N.AZ),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Nevada--6 EVs--'.concat(N.NV),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Utah--6 EVs--'.concat(N.UT),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Colorado--10 EVs--'.concat(N.CO),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'New Mexico--5 EVs--'.concat(N.NM),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Oregon--8 EVs--'.concat(N.OR),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'North Dakota--3 EVs--'.concat(N.ND),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'South Dakota--3 EVs--'.concat(N.SD),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Iowa--6 EVs--'.concat(N.IA),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Mississippi--6 EVs--'.concat(N.MS),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Indiana--11 EVs--'.concat(N.IN),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Illinois--19 EVs--'.concat(N.IL),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Minnesota--10 EVs--'.concat(N.MN),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Wisconsin--10 EVs--'.concat(N.WI),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Missouri--10 EVs--'.concat(N.MO),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Arkansas--6 EVs--'.concat(N.AR),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Oklahoma--7 EVs--'.concat(N.OK),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Kansas--6 EVs--'.concat(N.KS),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Louisiana--8 EVs--'.concat(N.LA),
                            ...
                            s.jsx('path', {
                              ...
                              onMouseLeave: z,
                              stroke: '#a9a9a9',
                              'data-info': 'Virginia--13 EVs--'.concat(N.VA),
  ...
  M = function (a) {
    var t = a.currentPVTotals,
      ...
      M = y[0],
      b = y[1],
      k = ''.concat(i, 'PopVoteInput'),
      x = ''.concat(i.toUpperCase(), ' %'),
      N = function (l, e) {
        var a = null == l ? void 0 : l.target,
          s = null == a ? void 0 : a.value,
          i = e ? Number(e) : a ? Number(s) : 0,
          u = null != d ? d : n;
        'Maine' === r ? (u = '4') : 'Nebraska' === r && (u = '5');
        var p = Boolean(i) || c ? i / 100 : 0,
          f = Math.round(Number(u) * p),
          v =
            e || !1 === Boolean(l)
              ? null
              : null == l
  ...
  C = function (a) {
    var t,
      ...
      o = a.currentPVTotals,
      r = a.handlePropVotes,
      i = a.handleStateWinner,
      c = a.isFromStorage,
      u = a.popVotesData,
      p = a.statesData,
      f = 'Hide Popular Votes',
      v = l.useState(f),
      m = v[0],
      h = v[1],
      g = l.useState(!0),
      ...
      j = l.useState(
        (function (l) {
          ...
          return (
            l.map(function (l) {
              return (
                -1 === l.name.indexOf('-CD') && (e[l.stateCode] = d(l.winner)),
                e
              );
            }),
            e
      ...
      A = function (l) {
        ...
        E({ newWinningParty: l.newWinningParty, stateId: l.stateId }),
          S(e(e({}, L), u));
      };
    return s.jsxs(
      'div',
                      ...
                      e(
                        {
                          ...
                          onClick: function () {
                            var l = f;
                            M && (l = 'Show Popular Votes'), h(l), b(!M);
                          },
                        },
                        { children: m }
                      )
...
module.exports = function (a) {
  var t = a.candidateImageSources,
    ...
    r = void 0 === o || o,
    c = Boolean(localStorage.getItem('ElectoralCollegeStatus')),
    d = c
    ...
    F = R[0],
    H = R[1],
    K = c ? JSON.parse(localStorage.getItem('ElectoralCollegeStatus')) : k,
    $ = c ? JSON.parse(localStorage.getItem('PopularVoteStatus')) : [];
  l.useEffect(function () {
    ...
    l.useEffect(
      function () {
        c || alert('no saved data so loading blank');
      },
      [c]
    );
  return s.jsxs(
        ...
        children: [
          ...
          s.jsxs(
            ...
            e(
              ...
              {
                children: [
                  s.jsx(g, { currentEVTotals: z, currentPVTotals: p }),
                  s.jsx(h, {}),
                ],
              }
            )
