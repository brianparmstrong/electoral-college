      ...
      (o ||
        ...
        'production' !== process.env.NODE_ENV &&
          (function () {
            ...
            (r.Fragment = n), (r.jsx = bl), (r.jsxs = Ml);
          })()),
      r));
var s = t.exports,
  i = function (l) {
  ...
  b = function (a) {
    ...
    var V,
      ...
      z = function (l) {
        var e = l.target.id;
        b(e), x(l.currentTarget.dataset.info);
      },
      W = function () {
        x('');
      },
                  ...
                  children:
                    ...
                    s.jsxs('div', {
                      children: [
                        ...
                        s.jsx(
                          'p',
                          e({ className: 'map-info-stateevs' }, { children: I })
                        ),
                        s.jsx(
                          'p',
                          e(
  ...
  M = function (a) {
    ...
    var C = function (l, e) {
      ...
      if (Boolean(f) && s <= 100) {
        ...
        var M = [h, m, g, y, b];
        if (a) a.setAttribute('data-evsawarded', String(f)), o(M);
        else if (d) return f;
      }
    };
    return s.jsx(
                      ...
                      e(
                        {
                          ...
                          onClick: function () {
                            var l = v;
                            M && (l = 'Show Popular Votes'), g(l), k(!M);
                          },
                        },
                        { children: m }
                      )
